...
const skillsData: SkillDataItem[] = [
    {
        ...
        WEB приложениями.<br /><br /> В&nbsp;настоящее время я&nbsp;живу на&nbsp;юге России,
        в городе Ростов-на-Дону.
        Я&nbsp;работаю в&nbsp;сфере&nbsp;IT. Начало было положено в 2018 году на
        JAVA (для android), в&nbsp;сфере WEB с 2020 года, React.<br /><br />В&nbsp;настоящее время в&nbsp;основном
        погружен в&nbsp;различные веб-технологии (JS, VUE, ThreeJs и&nbsp;т.д.)
        для фронтовой части работы и&nbsp;Node js&nbsp;для серверной. Я&nbsp;всегда в&nbsp;поиске интересного опыта и
...
export const contactsData = {
    contactText: `<h1 class="font pro-display m m--500">CONTACT</h1><br /><br />
        Если вы хотите работать вместе не стесняйтесь <a href="mailto:Kukhmirov85@gmail.com" class="description-modal__link">связаться со мной</a>`,
    contactData: [ 
        {
            iconLink: github,
